...
class WandbLogger(Callback):
    ...
    def __init__(self, name_of_run, **kwargs):
        kwargs = {
            'project': 'DQN',
            #'name': 'Carnival-v0-baseline',
            'name': name_of_run,
            **kwargs
        }
        wandb.init(**kwargs)
    ...
    def on_episode_end(self, episode, logs):
        ...
        #calc sum of rewards per episode
        self.sum_rewards = self.sum_rewards + np.sum(self.rewards[episode])
