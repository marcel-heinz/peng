...
class Agent(object):
    ...
    def test(self, env, nb_episodes=1, action_repetition=1, callbacks=None, visualize=True,
             nb_max_episode_steps=None, nb_max_start_steps=0, start_step_policy=None, verbose=1,slow=False,slow_time=0.1):
        ...
        for episode in range(nb_episodes):
            ...
            while not done:
                ...
                if slow:
                    time.sleep(slow_time)#timer
                    
                #
                    
                #safe gif
                #folder = '/Users/marcel/Desktop/gifs/movie.gif'


                #if len(image_list)<100:
                    #img = Image.fromarray(img_for_gif)
                    #processed_observation = np.array(img)
                    #img = np.asarray(observation) 
                    #image_list.append(processed_observation)
                    #print(len(image_list))
                #else:
                    #print("img list is full")
                    #imageio.mimsave(folder,image_list)
